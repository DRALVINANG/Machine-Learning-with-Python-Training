...
st.write("- 🟦 **Cluster 1 (Blue)**: Low-value customers, who spend the least on fresh, milk, and grocery items.")
st.write("- 🟥 **Cluster 0 (Red)**: High-value customers, who spend the most on fresh, milk, and grocery items.")
st.write("- 🟩 **Cluster 2 (Green)**: Medium-value customers, with moderate spending habits.")
st.markdown("---")  # Separator Line
